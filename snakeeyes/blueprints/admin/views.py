...
def users(page):
    ...
    print("$$$$$$$$$$$$$$$$", paginated_users.page)

    return render_template('admin/user/index.html',
                           form=search_form, bulk_form=bulk_form,
                           found_users=paginated_users)
...
@admin.route('/coupons/new', methods=['POST', 'GET'])
...
def coupons_new():
    ...
    if form.validate_on_submit():
        ...
        if Coupon.create(params):
            flash('Coupon has been created.', 'success')
